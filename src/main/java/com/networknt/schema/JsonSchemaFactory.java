...
public class JsonSchemaFactory {
     ...
     *
     * <code>
     * com.networknt.schema.JsonSchemaFactory.builder(com.networknt.schema.JsonSchemaFactory.getDraftV4()).build();
     * </code>
     *
     ...
     *
     * @return com.networknt.schema.JsonSchemaFactory
     */
    @Deprecated
    ...
    public JsonSchema getSchema(final URI schemaUri, final SchemaValidatorsConfig config) {
        try {
            ...
            if (uriSchemaCache.containsKey(mappedUri)) {
                ...
                // This is important because if we use same com.networknt.schema.JsonSchemaFactory for creating multiple JSONSchema instances,
